...
```http
GET https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo} HTTP/1.1
...
```java
URL obj = new URL("https://$(catalog.host)/cross-recibos/api/v1/polizas/{id-poliza}/recibos?desdeFecha=2020-02-26&hastaFecha=2020-02-26");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
$.ajax({
  ...
  method: 'get',
  data: '?desdeFecha=2020-02-26&hastaFecha=2020-02-26',
  headers: headers,
  success: function(data) {
    console.log(JSON.stringify(data));
  }
...
```http
GET https://$(catalog.host)/cross-recibos/api/v1/polizas/{id-poliza}/recibos?desdeFecha=2020-02-26&hastaFecha=2020-02-26 HTTP/1.1
...
```http
GET https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/movimientos HTTP/1.1
...
```http
GET https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/movimientos/{id-movimiento} HTTP/1.1
...
```java
URL obj = new URL("https://$(catalog.host)/cross-recibos/api/v1/recibos-by-nif?fechaConsulta=2020-02-26");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
```http
GET https://$(catalog.host)/cross-recibos/api/v1/recibos-by-nif?fechaConsulta=2020-02-26 HTTP/1.1
...
```http
GET https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/pdf HTTP/1.1
...
```http
POST https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/carta HTTP/1.1
...
```http
POST https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/email HTTP/1.1
...
```http
POST https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/sms HTTP/1.1
...
```http
POST https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/reenvios-bancos HTTP/1.1
...
```http
POST https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/confirmaciones-pagos HTTP/1.1
