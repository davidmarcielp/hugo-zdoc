...
Agrupa la funcionalidad relacionada a la operativa de recibos asociados a pólizas
...
result = RestClient.get 'https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}',
  params: {
  }, headers: headers
...
r = requests.get('https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}', params={
...
result = RestClient.get 'https://$(catalog.host)/cross-recibos/api/v1/polizas/{id-poliza}/recibos',
  params: {
...
r = requests.get('https://$(catalog.host)/cross-recibos/api/v1/polizas/{id-poliza}/recibos', params={
  'desdeFecha': '2020-02-20',  'hastaFecha': '2020-02-20'
}, headers = headers)
...
```java
URL obj = new URL("https://$(catalog.host)/cross-recibos/api/v1/polizas/{id-poliza}/recibos?desdeFecha=2020-02-20&hastaFecha=2020-02-20");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
result = RestClient.get 'https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/movimientos',
  params: {
  }, headers: headers
...
r = requests.get('https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/movimientos', params={
...
result = RestClient.get 'https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/movimientos/{id-movimiento}',
  params: {
  }, headers: headers
...
r = requests.get('https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/movimientos/{id-movimiento}', params={
...
result = RestClient.get 'https://$(catalog.host)/cross-recibos/api/v1/recibos-by-nif',
  params: {
...
r = requests.get('https://$(catalog.host)/cross-recibos/api/v1/recibos-by-nif', params={
  'fechaConsulta': '2020-02-20'
}, headers = headers)
...
```java
URL obj = new URL("https://$(catalog.host)/cross-recibos/api/v1/recibos-by-nif?fechaConsulta=2020-02-20");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
result = RestClient.get 'https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/pdf',
  params: {
  }, headers: headers
...
r = requests.get('https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/pdf', params={
...
result = RestClient.post 'https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/carta',
  params: {
  }, headers: headers
...
r = requests.post('https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/carta', params={
...
result = RestClient.post 'https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/email',
  params: {
  }, headers: headers
...
r = requests.post('https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/email', params={
...
result = RestClient.post 'https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/sms',
  params: {
  }, headers: headers
...
r = requests.post('https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/sms', params={
...
result = RestClient.post 'https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/reenvios-bancos',
  params: {
  }, headers: headers
...
r = requests.post('https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/reenvios-bancos', params={
...
result = RestClient.post 'https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/confirmaciones-pagos',
  params: {
  }, headers: headers
...
r = requests.post('https://$(catalog.host)/cross-recibos/api/v1/recibos/{id-recibo}/confirmaciones-pagos', params={
